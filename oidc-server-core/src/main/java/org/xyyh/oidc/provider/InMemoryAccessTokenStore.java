...
import org.xyyh.oidc.core.OAuth2AccessTokenStore;
import org.xyyh.oidc.core.OidcAuthentication;
import org.xyyh.oidc.core.OAuth2ServerAccessToken;
import org.xyyh.oidc.core.OAuth2ServerRefreshToken;
...
public class InMemoryAccessTokenStore implements OAuth2AccessTokenStore {
    ...
    public void delete(String token) {
        OidcAuthentication authentication = this.tokenKeyAuthenticationRepository.remove(token);
    ...
    @Override
    public Optional<OAuth2ServerAccessToken> getAccessToken(OidcAuthentication authentication) {
